...
function Home() {
//initialisation du useEffect pour le charger au démarrage
...
// création du useEffect pour récupérer les movies
  useEffect(() => {
    fetch('https://mymoviz-backend-n8zk.vercel.app/movies')
...
console.log(movies)
  ...
  const moviesData = movies.map((data, i) => {
